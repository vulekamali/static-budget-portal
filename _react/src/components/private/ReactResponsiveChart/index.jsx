...
import DebounceFunction from './../../../utilities/js/DebounceFunction';


export default class ReactResponsiveChart extends Component {
  constructor(props) {
    super(props);
...
ReactResponsiveChart.propTypes = {
...
ReactResponsiveChart.defaultProps = {
  type: 'bar',
  resizeAction: null,
  minWidth: 250,
  breakpoint: 600,
