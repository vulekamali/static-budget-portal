...
var _SearchContainer = __webpack_require__(15);
...
var _SearchMarkup = __webpack_require__(16);
...
var _ResultsBox = __webpack_require__(19);
...
function SearchMarkup(_ref) {
  ...
  return (0, _preact.h)(
    ...
    (0, _preact.h)(_ResultsBox2.default, { loading: loading, results: results, focus: focus, keywords: keywords, selectedYear: selectedYear })
  );
}
...
var _ResultsGroup = __webpack_require__(20);
...
function ResultsBox(_ref) {
  ...
  return (0, _preact.h)(
    ...
    loading === null ? null : (0, _preact.h)(_ResultsGroup2.default, { results: results, loading: loading, selectedYear: selectedYear })
  );
}
...
var _DeptSearchContainer = __webpack_require__(23);
...
var _DeptSearchMarkup = __webpack_require__(26);
...
function Form(_ref) {
  ...
  var updateFilter = eventHandlers.updateFilter,
      openFilter = eventHandlers.openFilter;
...
function Results(_ref) {
  ...
  var content = results.map(function (group) {
    if (province.value === null || province.value === group.slug) {
...
var _SearchResultContainer = __webpack_require__(35);
...
var _SearchResultMarkup = __webpack_require__(36);
...
var SearchResultsContainer = function (_Component) {
  ...
  _createClass(SearchResultsContainer, [{
    ...
    key: 'render',
    value: function render() {
      return (0, _preact.h)(_SearchResultMarkup2.default, { state: this.state, search: this.props.search, selectedYear: this.props.selectedYear, updateFilter: this.updateFilter });
    }
  }]);
...
/***/ })
/******/ ]);
//# sourceMappingURL=scripts.aaba297e62c28d3ce61b.js.map