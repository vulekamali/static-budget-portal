...
var _SearchContainer = __webpack_require__(6);
...
function Search() {
  ...
  if (nodesArray.length > 0) {
    nodesArray.forEach(function (node) {
      (0, _preact.render)((0, _preact.h)(_SearchContainer2.default, null), node);
    });
  }
}
...
var _SearchMarkup = __webpack_require__(7);
...
var SearchContainer = function (_Component) {
  ...
  _createClass(SearchContainer, [{
    ...
    key: 'initRequest',
    value: function initRequest(value, url) {
      var _this3 = this;
...
var _ResultsBox = __webpack_require__(10);
...
function Form(_ref) {
  ...
  var updateKeyword = function updateKeyword(event) {
    return initRequest(event.target.value, 'https://treasurydata.openup.org.za/api/3/action/package_search?q=' + event.target.value);
  };
...
var _ResultsGroup = __webpack_require__(11);
...
/***/ })
/******/ ]);
//# sourceMappingURL=scripts.4d048cb6a3dc4ac5fc3f.js.map