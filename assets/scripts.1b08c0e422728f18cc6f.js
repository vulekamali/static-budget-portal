...
function Form(_ref) {
  ...
  var year = selectedYear === '2017-18' ? '' : selectedYear + '/';
  var searchUrl = '/static-budget-portal/' + year + 'search-result/?search=' + keywords;
...
function ResultsBox(_ref) {
  ...
  return (0, _preact.h)(
    ...
    (0, _preact.h)(_ResultsGroup2.default, { results: results, loading: loading, selectedYear: selectedYear })
  );
}
...
/***/ })
/******/ ]);
//# sourceMappingURL=scripts.1b08c0e422728f18cc6f.js.map