        ...
        <ul className="Videos-info">
          ...
          <li className="u-listItemReset">
            <ul className="u-listReset">
              {languageButtons.map(({ name, action }) => <li className="Videos-pillWrap"><a onClick={action} className="Button is-small is-inline u-marginRight5 u-marginBottom5">{name}</a></li>)}
            </ul>
          </li>
