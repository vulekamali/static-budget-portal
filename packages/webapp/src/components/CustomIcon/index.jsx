...
const returnContent = type => {
  switch (type) {
    ...
    case 'economic-affairs-and-agriculture':
      return <EconomicAffairsAndAgriculture />;
    case 'defence':
      return <Defence />;
    case 'debt-service-costs':
      return <DebtServiceCosts />;
    ...
    case 'learning-and-culture':
      return <LearningAndCulture />;
    case 'local-development-and-infrastructure':
      return <LocalDevelopmentAndInfrastructure />;

    case 'community-development':
      return <CommunityDevelopment />;
    case 'peace-and-security':
      return <PeaceAndSecurity />;
    case 'general-public-services':
      return <GeneralPublicServices />;
    case 'post-school-training':
      return <PostSchoolTraining />;
    default:
      return null;
  }
};
