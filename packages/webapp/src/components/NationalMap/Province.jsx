...
const gauteng = props => (
  <path
    {...props}
    d="M316 86c2-1 3-1 4 1s-3 1-3 2v11c1 5 9-5 10-2 1 2-1 1-2 3l-1 5c-3-1-2 7-5 4-2 0-4-2-4 2-2-1-3 0-3 2s3 2 4 3 0 3 2 3l2-1c1 0 3 2 2 3-3 1-2 3-5 3-2 0-3 2-4 3-1 0-5 2-3 4-3 1-2 2-3 4l-3-1-1 1-3-6c-2-1-6 1-6 2h-6v-5l2-4c-3 1-3-1-4-1l-7 3v-3c-1-1 0-1 1-2l2-2-1-3h2l2-6c1-4 2-3 5-5 0 1 1 3 3 1v2c4-2 8-2 5-8 6 1 2-7 5-6-1 2 6 1 5-3h1c1 2 4-1 4-1 2-1 3 1 4-1l-1-2z"
  />
);
...
const northWest = props => (
  <path
    {...props}
    d="M258 71c-1 7 4 3 7 5 3 3 6 0 9-1v-2h1l1 5c0 1 2 1 2 3h3l2 2h4s0 2 1 1c2-1 0-3 2-4l2 1h3v-2l2 2h6c0 1 5 2 2 4-1 1-3-3-3 1l1 1c3-1 3 1 4 3 1 4-4 5-4 3h-2c1 3 1 7-3 6l1 3-1 1v2h-1v1l-4 1-1-1h-1l-1-2-3 2-2 2-2 7h-2l1 3-2 2c-1 1-2 1-1 2v3l4-2 3-1c1 1 2 2 3 1l-1 4v5h-1c0 2-2 5-3 4-4-3-2 1-6 2v-2c-3 1-7-3-6 1l-2-1-4 3c-2-1-3 1-3 3-2-1-4 1-4 2s3 3 1 4c-1 1 0 2 1 2l-5 1c-1-1-4 3-5 4-2 2-1 5-3 4v-2h-2l-3-2-4 3-3 1c-3 0-4 2-7 3-1 0 0 3-3 4-3 0-1 4-4 4-3 2-4-3-5-5 3-1 4-4 6-6-3-1-7 1-7-3-1 1-4 3-2 4l-1 4c-3 1-1 10-6 5 2-2 0-3-1-3-2-1 1-3 1-5 0-6-12 4-9-4-4-1 2-8-2-9v3l-3-1v2c2 1-2 0-3 2-1 1-6-2-8-2 1-2-2-2-4-3s-2 0-3-2l-3-3c-3 2-4-5 0-5-1-2-3-5-1-6v-4l-3-1c-1-2-6-1-6-3v-12h-1l1-3h1l1-2c-2-2 2-3-1-4l3-5v-4h2c-1-2 2-4 2-5l2-1v2c1-1 4-3 6-2h4l1 2 3 1v1l1 1v-1l4 3c0 3 5 2 5 4h2v-1h2c2 0 2 2 3 2v1h1l6 1 8 2 4-3 9 1c1 0 6-3 7-5l2-8 4-9 1-7c3-2 9-2 13-3z"
  />
);
...
const Province = ({ name, activeProvinces = [], size }) => {
  return createElement(list[name], calcProps(!!activeProvinces.find(id => id === name), size));
};
