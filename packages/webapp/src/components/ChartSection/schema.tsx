...
const mockPreviewValue = (): TpreviewValue => parseInt(faker.finance.amount(100000000, 999999999));
...
// Type: TpreviewZoom
/**
 * This value is only used when working with charts with multiple levels. If
 * value is null, then the chart defaults to the broadest possible view.
 * However, if an id is passed, then the chart focuses in on the specific part
 ...
 * '2019-20'. phase e.g: 'original'. This usually corresponds to the data that
...
/**
 * This is a function that fires when either the year or phase is selected from
 * a drop down. The name of the phase or year that is clicked on will be passed
 ...
 * disabled. Furthermore, if `TselectObject` has a `selected` value, then a
