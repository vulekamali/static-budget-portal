...
/**
 *  All props accepted by the `<Presentation />` sub-component inside `<FocusAreaSummary />`
 *  component.
 */
...
// Type: TgetFocusAreaDataProps
/**
 * Props accepted by `TgetFocusAreaData`.
 */
export type TgetFocusAreaDataProps = {
  year: TfinancialYear;
};

// Type: TgetFocusAreaData
/**
 * A function call that returns all the data required to render a focus area for a specific `TfinancialYear`.
 */
export type TgetFocusAreaData = (TgetFocusAreaDataProps) => void;
...
export type TconstructGetFocusAreaDataProps = {
  setPageData: TsetErrorState;
  setPageDataLoading: TsetLoading;
  setError: TsetErrorState;
};
...
export type Tprops = {
  ...
  constructGetFocusAreaData: TconstructGetFocusAreaData;
