...
const placeholderText = (
  <DialogContentText>
    A live video-stream of the budget speech will be available on the Vulekamali homepage at{' '}
    <strong>14:00 PM</strong> on <strong>22 February 2019</strong>.
  </DialogContentText>
);
...
const Modal = ({ open, closeModal, videoUrl }) => (
  <Dialog {...{ open }} onClose={closeModal} TransitionComponent={Zoom}>
    ...
    <DialogContent>{videoUrl ? <Youtube src={videoUrl} /> : placeholderText}</DialogContent>
    <StyledDialogActions>
