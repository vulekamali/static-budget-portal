...
const buildCta = (index, datasetUrl) => {
...
const createProjectCard = (datasetUrl, Link = 'a') => (props, index, selected) => {
  const { id, subheading, heading, stage, totalBudget, activeProvinces = [], link, points } = props;
...
const ProjectList = ({ projects, datasetUrl, Link }) => {
  return (
    <Wrapper>
      <Content>
